...
},{"./codec":20,"./decode":22,"./decoder":23,"./encode":25,"./encoder":26,"./ext":30}],12:[function(require,module,exports){
(function (Buffer){
/* globals Buffer */
...
},{"./bufferish":18}],15:[function(require,module,exports){
// bufferish-buffer.js
...
},{"./bufferish":18}],16:[function(require,module,exports){
// bufferish-proto.js
...
},{"./buffer-lite":13,"./bufferish":18}],17:[function(require,module,exports){
...
},{"./bufferish":18}],18:[function(require,module,exports){
// bufferish.js
...
},{"./buffer-global":12,"./bufferish-array":14,"./bufferish-buffer":15,"./bufferish-proto":16,"./bufferish-uint8array":17,"isarray":9}],19:[function(require,module,exports){
// codec-base.js
...
},{"./bufferish":18,"isarray":9}],20:[function(require,module,exports){
// codec.js
...
},{"./codec-base":19,"./read-core":32,"./write-core":35}],21:[function(require,module,exports){
// decode-buffer.js
...
},{"./flex-buffer":31,"./read-core":32}],22:[function(require,module,exports){
// decode.js
...
},{"./decode-buffer":21,"event-lite":5}],24:[function(require,module,exports){
// encode-buffer.js
...
},{"./flex-buffer":31,"./write-core":35}],25:[function(require,module,exports){
// encode.js
...
},{"./encode-buffer":24,"event-lite":5}],27:[function(require,module,exports){
// ext-buffer.js
...
},{"./bufferish":18}],28:[function(require,module,exports){
// ext-packer.js
...
},{"./bufferish":18,"./encode":25}],29:[function(require,module,exports){
// ext-unpacker.js
...
},{"./bufferish":18,"./decode":22}],30:[function(require,module,exports){
// ext.js
...
},{"./codec-base":19,"./read-core":32,"./write-core":35}],31:[function(require,module,exports){
// flex-buffer.js
...
},{"./bufferish":18}],32:[function(require,module,exports){
// read-core.js
...
},{"./codec-base":19,"./ext-buffer":27,"./ext-unpacker":29,"./read-format":33,"./read-token":34}],33:[function(require,module,exports){
// read-format.js
...
},{"./bufferish":18,"./bufferish-proto":16,"ieee754":7,"int64-buffer":8}],34:[function(require,module,exports){
// read-token.js
...
},{"./read-format":33}],35:[function(require,module,exports){
// write-core.js
...
},{"./codec-base":19,"./ext-buffer":27,"./ext-packer":28,"./write-type":37}],36:[function(require,module,exports){
// write-token.js
...
},{"./bufferish":18,"./write-uint8":38,"ieee754":7,"int64-buffer":8}],37:[function(require,module,exports){
// write-type.js
...
},{"./bufferish":18,"./bufferish-proto":16,"./ext-buffer":27,"./write-token":36,"./write-uint8":38,"int64-buffer":8,"isarray":9}],38:[function(require,module,exports){
// write-unit8.js
...
},{"./agent-base":40,"./is-object":42,"./request-base":43,"./response-base":44,"component-emitter":4}],42:[function(require,module,exports){
'use strict';
...
},{"crypto":2}],47:[function(require,module,exports){
(function (Buffer){
...
},{"./encoding/address":50,"./encoding/encoding":51,"./nacl/naclWrappers":55,"./utils/utils":57,"buffer":3}],48:[function(require,module,exports){
...
},{"./client":49}],49:[function(require,module,exports){
...
function HTTPClient(token, baseServer, port) {
  ...
  this.get = async function (path, query) {
    try {
      return await request.get(this.address + path).set('X-algo-api-token', token).set('Accept', 'application/json').query(query);
    } catch (e) {
      throw e;
    }
  };
  ...
  this.post = async function (path, data) {
    try {
      return await request.post(this.address + path).set('X-algo-api-token', token).send(data);
    } catch (e) {
      throw e.response;
    }
  };
...
},{"superagent":41}],50:[function(require,module,exports){
...
},{"../nacl/naclWrappers":55,"../utils/utils":57,"hi-base32":6}],51:[function(require,module,exports){
/**
...
},{"msgpack-lite":11}],52:[function(require,module,exports){
const nacl = require('./nacl/naclWrappers');
...
let Algod = algod.Algod; // Errors

const ERROR_NOT_TRANSACTION_BUILDER = new Error("The transaction passed should be an Algorand transaction." + "Please use Transaction to construct one.");
const ERROR_NOT_BID_BUILDER = new Error("The bid passed should be an Algorand bid." + "Please use Bid to construct one.");
/**
...
},{"./bid":47,"./client/algod":48,"./encoding/address":50,"./mnemonic/mnemonic":53,"./nacl/naclWrappers":55,"./transaction":56}],53:[function(require,module,exports){
...
},{"../nacl/naclWrappers":55,"./wordlists/english":54}],54:[function(require,module,exports){
...
},{"js-sha512":10,"tweetnacl":46}],56:[function(require,module,exports){
(function (Buffer){
const address = require("./encoding/address");
...
},{"./encoding/address":50,"./encoding/encoding":51,"./nacl/naclWrappers":55,"./utils/utils":57,"buffer":3,"hi-base32":6}],57:[function(require,module,exports){
/**
