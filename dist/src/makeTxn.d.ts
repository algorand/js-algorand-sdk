...
export declare function makeKeyRegistrationTxnWithSuggestedParamsFromObject(o: Pick<RenameProperty<MustHaveSuggestedParams<KeyRegistrationTxn>, 'reKeyTo', 'rekeyTo'>, 'from' | 'note' | 'voteKey' | 'selectionKey' | 'voteFirst' | 'voteLast' | 'voteKeyDilution' | 'suggestedParams' | 'rekeyTo' | 'nonParticipation'>): txnBuilder.Transaction;
...
export declare function makeApplicationCreateTxnFromObject(o: Pick<RenameProperties<MustHaveSuggestedParams<AppCreateTxn>, {
    ...
    reKeyTo: 'rekeyTo';
}>, 'from' | 'suggestedParams' | 'onComplete' | 'approvalProgram' | 'clearProgram' | 'numLocalInts' | 'numLocalByteSlices' | 'numGlobalInts' | 'numGlobalByteSlices' | 'appArgs' | 'accounts' | 'foreignApps' | 'foreignAssets' | 'note' | 'lease' | 'rekeyTo'>): txnBuilder.Transaction;
/**
