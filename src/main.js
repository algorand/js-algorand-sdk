...
const seedEncoding = require('./encoding/seed');
...
/**
 * Generate a key pair from a seed and returns a new Algorand address and its corresponding secret key
...
function isValidSeed(seed) {
    return seedEncoding.isValidSeed(seed);
}
