...
```html
<script
  src="https://unpkg.com/algosdk@v1.20.0-beta.1/dist/browser/algosdk.min.js"
...
```html
<script
  src="https://cdn.jsdelivr.net/npm/algosdk@v1.20.0-beta.1/dist/browser/algosdk.min.js"
  integrity="sha384-MBUb3pc2VI86j87sLfTwm1kEs2PUDCOFXnXdgspn0lWSJOxr1gu4mZL6L7VE1ITH"
  crossorigin="anonymous"
></script>
```
